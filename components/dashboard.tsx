    ...
    <main className="flex-1 overflow-auto bg-background">
      <div className="mx-auto max-w-6xl p-4 sm:p-6">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="mt-1 text-sm sm:text-base text-amber-500/90">{motivation}</p>
          ...
          <Card className="border-border bg-card">
            <CardContent className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4">
              ...
              <div className="min-w-0">
                ...
                <p className="text-lg sm:text-xl font-bold text-foreground">7 днів</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-border bg-card">
            <CardContent className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4">
              ...
              <div className="min-w-0">
                ...
                <p className="text-lg sm:text-xl font-bold text-foreground">12.5 год</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-border bg-card">
            <CardContent className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4">
              ...
              <div className="min-w-0">
                ...
                <p className="text-lg sm:text-xl font-bold text-foreground">14 / 24</p>
              </div>
            </CardContent>
          </Card>
        </div>
