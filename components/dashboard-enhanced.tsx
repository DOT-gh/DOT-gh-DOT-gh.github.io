...
import { Code2, Globe, Cpu, ChevronRight, Zap, Trophy, TrendingUp, Award } from "lucide-react"
...
import { StreakFreeze } from "@/components/gamification/streak-freeze"
import { ThemeCustomization } from "@/components/gamification/theme-customization"
import { MilestoneRewards } from "@/components/gamification/milestone-rewards"
      ...
      <div className="mx-auto max-w-7xl p-4 sm:p-6">
        ...
        <Tabs defaultValue="achievements" className="w-full">
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="themes">Теми</TabsTrigger>
            <TabsTrigger value="rewards">Нагороди</TabsTrigger>
          </TabsList>
