...
import { Bot, User, Send, Sparkles, Trash2, ChevronRight, ChevronLeft } from "lucide-react"
...
export function AiTutorChat() {
  ...
  const quickActions = [
    ...
    { label: "Поясни синтаксис", query: "Поясни синтаксис for циклу" },
  ]

  if (collapsed) {
    return (
      <aside className="flex w-12 flex-col bg-sidebar border-l border-border">
  ...
  return (
    <aside className="flex w-80 flex-col bg-sidebar">
      {/* Header */}
