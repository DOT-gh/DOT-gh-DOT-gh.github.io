...
function AnalyticsView({ isDemo, screenMode }: { isDemo: boolean; screenMode: boolean }) {
  ...
  // Реальні дані з опитування та практики
  ...
  // Активність по днях (17-23 грудня 2025 - остання неділя)
  const activityData = [
    ...
    <div className="p-6 space-y-6">
      ...
      <Card className={screenMode ? "bg-white border-gray-200" : ""}>
        <CardHeader>
          ...
          <CardDescription>17-23 грудня 2025 (остання неділя перед дедлайном)</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className={screenMode ? "bg-white border-gray-200" : ""}>
        <CardHeader>
          ...
          <CardDescription>33 відповіді з 72 учнів (46% response rate)</CardDescription>
        </CardHeader>
        <CardContent>
