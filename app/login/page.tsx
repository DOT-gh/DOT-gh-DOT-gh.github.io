...
import { Terminal, Zap, Shield, Loader2, ArrowLeft } from "lucide-react"
    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center p-4">
        <div className="mb-8 flex items-center gap-2">
          ...
          <span className="text-xl font-bold">Edu Survival Kit</span>
        ...
        <Card className="w-full max-w-md border border-primary/40 bg-card/90 shadow-2xl shadow-primary/20 ring-1 ring-primary/20 backdrop-blur">
          <CardHeader className="space-y-3 text-center">
            ...
            <CardDescription className="text-base">
              Увійдіть, щоб зберігати прогрес, досягнення та код між сесіями
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-3 border-t border-border/50 pt-5">
              <div className="flex flex-col items-center gap-1.5 text-center">
                ...
                <span className="text-xs text-muted-foreground">Офлайн-режим</span>
              </div>
              <div className="flex flex-col items-center gap-1.5 text-center">
                <div className="flex size-9 items-center justify-center rounded-lg bg-primary/10">
                  <Shield className="size-4 text-primary" />
                </div>
                <span className="text-xs text-muted-foreground">Безпечний вхід</span>
              </div>
              <div className="flex flex-col items-center gap-1.5 text-center">
                <div className="flex size-9 items-center justify-center rounded-lg bg-primary/10">
                  <Terminal className="size-4 text-primary" />
                </div>
                <span className="text-xs text-muted-foreground">Прогрес у хмарі</span>
              </div>
            </div>
